    ...
    <main className="w-full bg-black overflow-x-hidden">
      <div className="container mx-auto grid place-items-center px-2 lg:px-0">
        <section className="grid grid-cols-1 auto-rows-min md:grid-cols-2 gap-y-8 md:gap-8 py-8 items-start lg:w-3/4">
          ...
          <div className='bg-gray p-3 rounded-lg shadow-lg row-start-2 row-end-3 md:row-start-1 md:row-end-2 md:col-start-2 md:col-end-3 flex flex-col items-end h-full'>
            <StandingTablePreview 
          ...
          <div className="relative text-yellow col-start-1 col-end-3 row-start-3 row-end-4 md:row-start-2 md:row-end-3 bg-[url('/assets/champions-banner.webp')] bg-no-repeat bg-cover bg-center rounded-lg shadow-lg overflow-x-hidden w-full after:absolute after:top-0 after:left-0 after:bg-black/80 after:rounded-lg after:w-full after:h-full after:-z-10 z-20">
            <Link href={`/league/${getLeagueId({ leagueName: 'uefachampionsleague' })}/results`} className="text-balance text-center pt-4 block transition-all ease-in-out duration-200 hover:text-purple">
